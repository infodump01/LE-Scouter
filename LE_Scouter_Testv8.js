...
// @version      10.6-pdafix
// @description  RSI badges on profiles and overlays; unified for Tampermonkey & Torn PDA
...
(() => {
    // ---- Environment Adapter ----
    const isPDA = (typeof PDA_httpGet === 'function') || (typeof GM_getValue !== 'function');
    ...
    function waitForHeader() {
        ...
        apiGet(`/user/${m[1]}?selections=personalstats,basic`, od => {
