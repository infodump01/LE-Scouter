// ==UserScript==
// @name         LE Scouter Base v1.2.3 (Minimal RSI Banner Patch)
// @namespace    Violentmonkey Scripts
// @match        https://www.torn.com/*
// @match        https://pda.torn.com/*
// @version      1.2.3
// @description  RSI arrow and live-updating plane icon for travel status; custom tooltip only (never double); RSI banner restored for profile pages, robust to missing .life
...
(() => {
  ...
  function injectProfile() {
    ...
    apiGet(`/user/${userId}?selections=personalstats,basic,profile`, o => {
      // --- PATCH: fallback if .life is missing ---
      if (!o.life || typeof o.life.current !== 'number' || typeof o.life.maximum !== 'number') {
        o.life = { current: 100, maximum: 100 };
      }
      // --- END PATCH ---
