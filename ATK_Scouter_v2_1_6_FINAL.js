// ==UserScript==
// @name         ATK Scouter v2.1.6
// @namespace    Violentmonkey Scripts
// @match        https://www.torn.com/*
// @match        https://pda.torn.com/*
// @version      2.1.6
// @description  FIXED: IndexedDB schema bug causing Fight Intel panel to fail on mobile - proper error handling and database repair
...
/*
 * ATK SCOUTER v2.1.6 - RELEASE NOTES
 * 
 * MAJOR FEATURES:
 * ===============
 * 
 ...
 * 
 * RECENT UPDATES (v2.0.0 → v2.1.6):
 * ==================================
 * 
 * v2.1.6 - IndexedDB Schema Fix (Current) - CRITICAL MOBILE FIX:
