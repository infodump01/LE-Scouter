// ==UserScript==
// @name         ATK Scouter v2.1.7
// @namespace    Violentmonkey Scripts
// @match        https://www.torn.com/*
// @match        https://pda.torn.com/*
// @version      2.1.7
// @description  FIXED: Duplicate fight logging - now only processes attackLog page (not attack page) to prevent wins/losses from being logged twice
...
/*
 * ATK SCOUTER v2.1.7 - RELEASE NOTES
 * 
 * MAJOR FEATURES:
 * ===============
 * 
 ...
 * 
 * RECENT UPDATES (v2.0.0 → v2.1.7):
 * ==================================
 * 
 * v2.1.7 - Duplicate Logging Fix (Current) - CRITICAL:
