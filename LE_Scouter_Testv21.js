// ==UserScript==
// @name         LE Scouter Base v1.2.1 + Life% & Last Action + Larger Tooltip Arrows (PDA Fixed, Cancel Red Fix)
// @namespace    Violentmonkey Scripts
// @match        https://www.torn.com/*
// @match        https://pda.torn.com/*
// @version      1.2.1-life-action-relative-tooltips-larger-pdafix-cancelfix
// @description  Two-tab dark GUI; injured+drug indicators; on profiles show Life% & “Last action” (shortened); on list pages inject larger 20×20px RSI arrows into honorWrap with tooltips that follow the cursor—now also runs on TORN PDA (pda.torn.com). Cancel button in the modal is once again red.
// @updateURL    https://raw.githubusercontent.com/infodump01/LE-Scouter/main/LE_Scouter_v1.2.1_life_action_relative_tooltips_larger_pdafix_cancelfix.js
// @downloadURL  https://raw.githubusercontent.com/infodump01/LE-Scouter/main/LE_Scouter_v1.2.1_life_action_relative_tooltips_larger_pdafix_cancelfix.js
...
(() => {
  ...
  GM_addStyle(`
    ...
    .ff-list-arrow {
      ...
      width:0;
      height:0;
      border-top:10px solid transparent;    /* was 8px */
      border-bottom:10px solid transparent; /* was 8px */
      border-right:20px solid #2e7d32;      /* was 12px */
      pointer-events:auto;
      z-index:10;
    }
    ...
    .ff-modal .btn-cancel {
      background:#c62828; color:#fff; /* ← red again */
    }
  ...
  function injectProfile() {
    ...
    // — If we *did* find a desktop heading, insert there once and return —
    ...
    // — If *no* desktop heading was found, only *then* do the PDA/mobile fallback —
    if (!heading) {
      // Find a generic “profile wrapper” (mobile/PDA). Try several common selectors:
      let mobileWrapper = document.querySelector('.bodyWrap__dnkU')
                       || document.querySelector('#appWrap')
                       || document.querySelector('main')
                       || document.body;

      // Avoid inserting twice on mobile
      ...
      apiGet(`/user/${userId}?selections=personalstats,basic,profile`, o => {
        ...
        // Create a new <div class="ff-score-badge…"> and prepend it to mobileWrapper
  ...
  // ---- Build GUI (only change: Cancel button is now `class="btn btn-cancel"`) ----
