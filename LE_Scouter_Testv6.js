...
(() => {
    ...
    if (typeof PDA_httpGet === 'function') {
        // PDA: wrap raw body into XHR-like interface
    ...
    function waitForHeader() {
        ...
        apiGet(`/user/${opId}?selections=personalstats,basic`, od => {
            ...
            if (pct<100) { cls='high'; note='High risk'; } else if(pct<120) { cls='med'; note='Moderate risk'; }
            const span = document.createElement('span'); span.className=`ff-score-badge ${cls}`;
